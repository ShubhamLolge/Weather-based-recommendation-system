...
class SalesPredictionPageState extends State<SalesPredictionPage> {
  ...
  Future<void> _fetchWeatherData() async {
    ...
    if (location.isNotEmpty) {
      ...
      if (weatherResponse.statusCode == 200) {
        ...
        print('Error fetching weather data: ${weatherResponse.body}'); // Debugging line
        setState(() {
  ...
  Future<void> _sendDataAndPredict() async {
    ...
    print(
        'Sending data to Flask API: location: $location, temperature: $temperature, rain: $rain, wind_speed: $windSpeed, humidity: $humidity, pressure: $pressure, visibility: $visibility, clouds: $clouds, weather: $weatherMain, csv_data: $csvData');
...
//         final rain = weatherData['rain'] != null ? weatherData['rain']['1h'] ?? 0 : 0;
